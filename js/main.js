...
var mbTiles = new L.tileLayer('https://tiki.bn.ee/php/mbtiles.php?z={z}&x={x}&y={y}', {
    tms: true,
    attribution: 'Tiles Courtesy of <a href="https://tiles.mapbox.com/mapbox/map/geography-class" target="_blank">MapBox</a>',
});

var mapboxFallback = new L.TileLayer('https://a.tiles.mapbox.com/v3/brendannee.map-28wp10x1/{z}/{x}/{y}.png');
